...
console.log(`Key locations: ${first}, second: ${second}`);
...
const [firstSton, , , , sixthStone] = stones;
...
revealPath({direction: "north", distance: 150});
...
function mixPotion ({ingredient1 = "Water", ingredient2 = "Fireflower"} = {}) {
	console.log(`Mixing ${ingredient1} with ${ingredient2} for a potion.`);
}
mixPotion({ingredients1: "Rosemary"});
...
const {outer: {inner: "The Final Key"}} = nestedSecret;
